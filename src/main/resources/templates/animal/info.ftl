...
<div class="container-fliud">
    <div class="wrapper row">
        ...
        <div class="details col-md-6">
            ...
            <h5 class="colors">Вік:${animal.age}</h5>
            <h5 class="colors">Вид:${animal.animalType}</h5>
            <h5 class="colors">Дата додавання:${animal.createdDate}</h5>
            <h5 class="colors">Статус:${animal.animalStatus}</h5>
            <div class="action">
