...
<head>
    ...
    <script type="text/javascript">
        window._wpemojiSettings = {
            ...
            "svgExt": ".svg",
            "source": {"concatemoji": "https:\/\/bridge82.qodeinteractive.com\/wp-includes\/js\/wp-emoji-release.min.js?ver=5.3"}
        };
        !function (e, a, t) {
                                            ...
                                            <div class="feature-box">
                                                <div class="clearfix">
                                                    ...
                                                    <div class="feature-content">
                                                        ...
                                                        <p>Адресна допомога або цільова здійснюється на картку-ключ Голови ГО БО "Дім Сірка" Когут Н.В.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="feature-box">
                                                <div class="clearfix">
                                                    ...
                                                    <div class="feature-content">
                                                        ...
                                                        <p>Поширення наших публікацій і оголошень, запрошення своїх друзів до нашої групи.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<div class="qode-demos-toolbar" data-demo="bridge82.qodeinteractive.com">
    ...
    <script type="text/javascript">
        ...
        var wpcf7 = {
            "apiSettings": {
                "root": "https:\/\/bridge82.qodeinteractive.com\/wp-json\/contact-form-7\/v1",
