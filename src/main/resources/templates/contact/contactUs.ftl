                    ...
                    <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-6 vc_col-md-6">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper">
                                <div class='google_map_shortcode_holder' style='height:378px;'>
                                    <div class='qode_google_map' style='height:378px;'
                                         id='map_canvas_18857'
                                         data-addresses='["Strandgade 44 1401 København K, Denmark"]'
                                         data-custom-map-style='false' data-color-overlay='#393939'
                                         data-saturation='-100' data-lightness='-60' data-zoom='16'
                                         data-pin='https://bridge82.qodeinteractive.com/wp-content/uploads/2016/11/pin.png'
                                         data-unique-id='18857' data-google-maps-scroll-wheel='false'
                                         data-map-height='378'></div>
                                ...
                                <div class="wpb_text_column wpb_content_element ">
                                    <div class="wpb_wrapper">
                                        <p>World’s largest no-kill rescue and adoption organization with
                                            hundreds of dogs, cats, puppies and kittens available</p>
                                    </div>
                                </div>
                            ...
                            <div class="wpb_wrapper">
                                <div role="form" class="wpcf7" id="wpcf7-f126-p127-o1" lang="en-US"
                                    ...
                                    <form action="/contact-us/#wpcf7-f126-p127-o1" method="post"
                                        ...
                                        <p><input type="submit" value="Donate Now"
